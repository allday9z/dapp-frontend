...
export const AddOnNavbarMobile = ({
  ...
  useEffect(() => {
    const onScroll = () => {
      ...
      scrollTimer.current = setTimeout(() => setVisible(false), 1500);
    };
  ...
  return (
    <div
      className={`addon-navbar-mobile${visible ? " addon-navbar-mobile--visible" : ""}`}
      aria-hidden={!visible}
    >
      <div className="addon-navbar-mobile__collapse">
