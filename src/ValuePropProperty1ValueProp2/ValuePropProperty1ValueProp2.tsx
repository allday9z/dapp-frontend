import "./ValuePropProperty1ValueProp2.css";
...
export interface IValuePropProperty1ValueProp2Props {
  property1?: "value-prop-1" | "value-prop-2" | "value-prop-3";
  className?: string;
}

export const ValuePropProperty1ValueProp2 = ({
  property1 = "value-prop-1",
  className,
  ...props
}: IValuePropProperty1ValueProp2Props): JSX.Element => {
