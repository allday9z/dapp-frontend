import "./AppTileAppleRepair.css";
import { AppBlockImageVariant11 } from "../AppBlockImageVariant11/AppBlockImageVariant11";

export interface IAppTileAppleRepairProps {
...
export const AppTileAppleRepair = ({
  device = "desktop",
  title = "mac-book-pro",
  category = "what-s-new",
  className,
  ...props
}: IAppTileAppleRepairProps): JSX.Element => {
  ...
  return (
    ...
    >
      <div className="app-block-tile">
        <AppBlockImageVariant11 className="app-block-image-instance"></AppBlockImageVariant11>
