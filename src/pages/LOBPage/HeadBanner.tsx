...
export const HeadBanner = () => (
    ...
    <section className="lob-page__banner which-mac-is-right-for-you is-mobile" aria-label="MacBook hero banner" style={{ display: "flex", justifyContent: "center", alignItems: "center", backgroundColor: "#FAFAFA", borderBottom: "1px solid #E0E0E0", width: "100%" }}>
        <img
            className="lob-page__banner-image"
            src="https://filebrowser-dapp-uficon.coolify.pve01.prod.uficon.com/api/public/dl/FH-wjIaJ/DAPP/Banner%20Dynamic%20%5BMac%5D-03.webp"
            alt="Mac View All"
            about="การเลือก Mac ที่ใช่สำหรับคุณ"
