import "./ValuePropProperty1ValueProp1.css";
...
export interface IValuePropProperty1ValueProp1Props {
  property1?: "value-prop-1" | "value-prop-2" | "value-prop-3";
  className?: string;
}

export const ValuePropProperty1ValueProp1 = ({
  property1 = "value-prop-1",
  className,
  ...props
}: IValuePropProperty1ValueProp1Props): JSX.Element => {
