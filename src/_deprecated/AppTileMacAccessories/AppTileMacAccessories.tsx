import "./AppTileMacAccessories.css";
import { AppBlockImageVariant12 } from "../AppBlockImageVariant12/AppBlockImageVariant12";

export interface IAppTileMacAccessoriesProps {
...
export const AppTileMacAccessories = ({
  device = "desktop",
  title = "mac-book-pro",
  category = "what-s-new",
  className,
  ...props
}: IAppTileMacAccessoriesProps): JSX.Element => {
  ...
  return (
    ...
    >
      <div className="app-block-tile">
        <AppBlockImageVariant12 className="app-block-image-instance"></AppBlockImageVariant12>
