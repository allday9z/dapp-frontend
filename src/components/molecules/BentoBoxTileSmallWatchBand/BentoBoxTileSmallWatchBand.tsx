  ...
  return (
    ...
    >
      <div className="image-area">
        <img className="image-120" src="https://filebrowser-dapp-uficon.coolify.pve01.prod.uficon.com/api/public/dl/FH-wjIaJ/DAPP/IMG-iphone17e-homepage_highlight_3_banner_retina_medium.jpg?inline=true" alt="" loading="lazy" decoding="async" fetchPriority="low" width={205} height={205} />
      </div>
