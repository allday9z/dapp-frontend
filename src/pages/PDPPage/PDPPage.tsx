...
type PDPCollection = "macbook-pro";
type BundleItems = "macbook-pro";
type SKUCode = typeof macbookProFamilyItems;
...
export const PDPPage = ({ collection = "macbook-pro" }: PDPPageProps) => {
