import "./AppTileFindStore.css";
import { AppBlockImageVariant9 } from "../AppBlockImageVariant9/AppBlockImageVariant9";

export interface IAppTileFindStoreProps {
...
export const AppTileFindStore = ({
  device = "desktop",
  title = "mac-book-pro",
  category = "what-s-new",
  className,
  ...props
}: IAppTileFindStoreProps): JSX.Element => {
  ...
  return (
    ...
    >
      <div className="app-block-tile">
        <AppBlockImageVariant9 className="app-block-image-instance"></AppBlockImageVariant9>
