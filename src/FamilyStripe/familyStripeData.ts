...
export interface FamilyStripeConfig {
  category: string;
  seeAllLabel: string;
  seeAllHref: string;
...
export const macbookProFamilyStripe: FamilyStripeConfig = {
  ...
  items: [
    {
      ...
      href: "/mac/macbook-pro/macbook-pro-14-m4-pro",
    },
    {
      id: "mbp-16-m4",
      ...
      href: "/mac/macbook-pro/macbook-pro-16-m4-pro",
    },
    {
      id: "mba-13-m5",
